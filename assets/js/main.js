...
const CATEGORIAS = [
  ...
  { id: "mujer-verano", label: "Mujer verano" },
  { id: "mujer-invierno", label: "Mujer invierno" },
  { id: "hombre", label: "Hombre" },
  { id: "accesorios", label: "Accesorios" },
  { id: "calzado", label: "Calzado" },
  { id: "deco-bazar", label: "Deco / Bazar" },
  { id: "ceramica-artesanal", label: "Cerámica artesanal outlet" },
];
